...
control = open("data/pdg_data.txt", "r")
control = control.readlines()[0].split("[")[1]
control = control.split("]")[0]
controlData = control.split(",")

real = open("data/real_data.txt", "r")
real = real.readlines()[0].split("[")[1]
real = real.split("]")[0]
realData = real.split(",")

init = open("data/initial_pdg_data.txt", "r")
